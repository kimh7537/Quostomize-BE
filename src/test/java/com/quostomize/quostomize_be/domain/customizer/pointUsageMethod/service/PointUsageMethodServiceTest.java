...
//public class PointUsageMethodServiceTest {
//
//    @InjectMocks
...
//    @BeforeEach
//    void setUp(){
//        MockitoAnnotations.openMocks(this); //Mock객체를 초기화
//    }
//
//    @Test
...
//                .thenReturn(Optional.of(pointUsageMethod));
//
//        pointUsageMethodService.togglePointUsage(cardSequenceId)
//
//        // when & then
//        EntityNotFoundException exception = assertThrows(new EntityNotFoundException.class, () ->
