...
public class UpperAndLowerClassificationByIndex {
    ...
    public void getUpperList(Map.Entry<String, HashMap<String, Integer>> entry, StockInformationRepository stockInformationRepository, String preSignedUrl, List<StockRecommendResponse> recommendResponses){
    ...
    public void getLowerList(Map.Entry<String, HashMap<String, Integer>> entry, StockInformationRepository stockInformationRepository, String preSignedUrl, List<StockRecommendResponse> recommendResponses){
        String category = entry.getKey();
