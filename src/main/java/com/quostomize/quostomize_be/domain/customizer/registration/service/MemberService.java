...
//    private final PasswordEncoder passwordEncoder;
    ...
    public void validateRequest (MemberRequestDto requestDto) {

        // 아이디 양식 확인
        if (!requestDto.isValidMemberLoginId(requestDto.memberLoginId())){
        ...
        // 휴대전화 양식 확인
        if (!MemberRequestDto.isValidPhoneNumber(requestDto.memberPhoneNumber())) {
    ...
    public void saveMember (MemberRequestDto memberRequestDto) {
        ...
        validateRequest(memberRequestDto);
